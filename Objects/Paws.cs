...
namespace IIS.jjjhhjhjhjhjhjh
{
    ...
    public class Paws : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.jjjhhjhjhjhjhjh.Cat fCat;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.jjjhhjhjhjhjhjh.Cat.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Cat"})]
        public virtual IIS.jjjhhjhjhjhjhjh.Cat Cat
        {
            get
            {
                ...
                IIS.jjjhhjhjhjhjhjh.Cat result = this.fCat;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View PawsE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("PawsE", typeof(IIS.jjjhhjhjhjhjhjh.Paws));
                }
            }
        }
    }
    ...
    public class DetailArrayOfPaws : ICSSoft.STORMNET.DetailArray
    {
        ...
        //  *** Start programmer edit section *** (IIS.jjjhhjhjhjhjhjh.DetailArrayOfPaws members)

        //  *** End programmer edit section *** (IIS.jjjhhjhjhjhjhjh.DetailArrayOfPaws members)
        ...
        /// </summary>
        public DetailArrayOfPaws(IIS.jjjhhjhjhjhjhjh.Cat fCat) : 
                base(typeof(Paws), ((ICSSoft.STORMNET.DataObject)(fCat)))
        {
        }
        
        public IIS.jjjhhjhjhjhjhjh.Paws this[int index]
        {
            get
            {
                return ((IIS.jjjhhjhjhjhjhjh.Paws)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.jjjhhjhjhjhjhjh.Paws dataobject)
        {
